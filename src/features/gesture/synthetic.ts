...
/**
 * Synthetic 21-point hand observations. Used by unit tests AND by the web
 * demo's "제스처 시뮬레이션" mode so the gesture flow is demoable/testable on a
 * machine with no webcam. Pure, framework-free.
 */
